...
{ 
  ...
  },
  {
    ...
    "kana": "みかねる",
    "pos": "动词",
    "meaning": "实在看不下去。包含着同情或焦急的情绪，无法袖手旁观，心里干着急，眉头紧锁想要插手或制止的状态。",
    "example_jp": "重い荷物を引きずるお婆さんを見かねて、思わず手を貸した。",
    "example_cn": "实在看不下去老奶奶拖着沉重的行李，我下意识地伸出了手。"
  },
  {
    "id": 702,
    "word": "小屋",
    ...
    "kana": "こや",
    "pos": "名词",
    "meaning": "小屋/棚子。简陋、面积小、通常用于存放杂物或临时避难的简易建筑，透着阴暗和逼仄感。",
    "example_jp": "突然の大雨で、山の中腹にある薄暗いボロ小屋に逃げ込んだ。",
    "example_cn": "突降大雨，我们狼狈地躲进了半山腰那间昏暗破旧的木棚里。"
  },
  {
    "id": 703,
    "word": "締め付ける",
    ...
    "kana": "しめつける",
    "pos": "动词",
    "meaning": "紧紧勒住/施加压力。不仅指物理上用力绑紧，常引申为精神上的压迫，或是胸口因悲伤猛然揪紧、呼吸变得困难的窒息感。",
    "example_jp": "捨て犬の悲惨な最期を描いた映画に、胸がギュッと締め付けられた。",
    "example_cn": "看到被遗弃的小狗悲惨离世的电影画面，我的心猛地揪紧了。"
  },
  {
    "id": 704,
    "word": "外れ",
    ...
    "kana": "〜はずれ",
    "pos": "名词",
    "meaning": "边缘/落空。指偏离中心位置，或未达到预期（如没中奖、猜错），伴随一种扑空或被边缘化的失落挫败感。",
    "example_jp": "期待を込めて引いたくじは、無情にも「外れ」の二文字だった。",
    "example_cn": "满怀期待抽出的签上，无情地印着“没中”两个大字。"
  },
  {
    "id": 705,
    "word": "肩身",
    ...
    "kana": "かたみ",
    "pos": "名词",
    "meaning": "面子/处境。人在群体中的体面。搭配“狭い（感到局促）”表示因自卑或做错事而畏缩不前、恨不得找个地缝钻进去的窘迫感。",
    "example_jp": "同窓会で自分だけがフリーターで、ひどく肩身の狭い思いをした。",
    "example_cn": "同学聚会上只有我一个人到处打零工，感觉局促得实在抬不起头来。"
  },
  {
    "id": 706,
    "word": "気心",
    ...
    "kana": "きごころ",
    "pos": "名词",
    "meaning": "脾气/性情。通常指交往久了之后摸透的对方的真实内心，包含一种不需要伪装、可以彻底卸下防备的亲密感。",
    "example_jp": "気心の知れた仲間となら、安い居酒屋でも朝まで笑い転げられる。",
    "example_cn": "和摸透彼此脾气的挚友在一起，哪怕在廉价小酒馆也能捧腹大笑到天亮。"
  },
  {
    "id": 707,
    "word": "名ばかり",
    ...
    "kana": "なばかり",
    "pos": "名词",
    "meaning": "徒有虚名/有名无实。只有头衔好听，实际内容完全配不上，常带有被忽悠的失望、讽刺或无奈感。",
    "example_jp": "「店長」なんて名ばかりで、毎日の仕事はトイレ掃除とレジ打ちだ。",
    "example_cn": "所谓“店长”根本徒有虚名，我每天的活儿就是刷马桶和收银。"
  },
  {
    "id": 708,
    "word": "結び付ける",
    ...
    "kana": "むすびつける",
    "pos": "动词",
    "meaning": "联系在一起/挂钩。将物理上独立的事物死死拴紧，或在逻辑上强行建立因果关系，常常是主观上的钻牛角尖。",
    "example_jp": "彼女はちょっとしたミスをすぐ自分の才能不足と結び付けて落ち込む。",
    "example_cn": "她总把一点小失误和自己能力不足强行挂钩，然后一个人低着头沮丧。"
  },
  {
    "id": 709,
    "word": "垣",
    ...
    "kana": "かき",
    "pos": "名词",
    "meaning": "篱笆/围墙。用竹子或树木编成用来隔绝视线的物理屏障，也常引申为人与人之间竖起防备、互相试探的心理隔阂。",
    "example_jp": "隣の家の犬が、低い生け垣の隙間からこちらをじっと見つめていた。",
    "example_cn": "邻居家的狗从低矮的树篱缝隙里，直勾勾地盯着我这边看。"
  },
  {
    "id": 710,
    "word": "立ち往生",
    ...
    "kana": "たちおうじょう",
    "pos": "名词/动词",
    "meaning": "进退两难/抛锚。原指站着死去，现代常指车或人在半路上卡住死死动弹不得，充满焦急、频频看表却无计可施的困境感。",
    "example_jp": "大雪で電車が駅と駅の間で立ち往生し、車内にはため息が充満した。",
    "example_cn": "大雪导致电车在两站之间抛锚卡死，车厢里挤满了无奈叹气的乘客。"
  },
  {
    "id": 711,
    "word": "丈",
    ...
    "kana": "たけ",
    "pos": "名词",
    "meaning": "长度/身高/全部。指衣服的长度，引申为“倾注全部（情感）”。包含一种丈量极限、毫无保留倾泻而出的压倒性感。",
    "example_jp": "背が急に伸びて、お気に入りのズボンの丈がツンツルテンになった。",
    "example_cn": "个子猛长，最喜欢的那条裤子裤腿短了一大截，光秃秃地露着脚踝。"
  },
  {
    "id": 712,
    "word": "暁",
    ...
    "kana": "あかつき",
    "pos": "名词",
    "meaning": "拂晓/……实现之时。黎明破晓前刺破黑暗的光芒，引申为经历了漫长的煎熬后，某项艰难任务最终大功告成的那个高光时刻。",
    "example_jp": "この過酷なプロジェクトが成功した暁には、最高級の肉で祝杯をあげよう。",
    "example_cn": "等熬过这个魔鬼项目大功告成的那一天，我们一定要用顶级的烤肉干杯庆祝。"
  },
  {
    "id": 713,
    "word": "物語る",
    ...
    "kana": "ものがたる",
    "pos": "动词",
    "meaning": "诉说/表明。不仅指讲故事，更常指某种无声的证据、斑驳的痕迹强烈且清晰地揭示了过去发生的事实，无需多言。",
    "example_jp": "職人の節くれだった真っ黒な手が、これまでの苦労を無言で物語っていた。",
    "example_cn": "老工匠那长满老茧、黑乎乎的双手，无声地诉说着他大半辈子的辛劳。"
  },
  {
    "id": 714,
    "word": "思い過ごす",
    ...
    "kana": "おもいすごす",
    "pos": "动词",
    "meaning": "多心/想得太多。脑补过度，自己吓自己把事情想得很严重，通常伴随着真相大白后的如释重负或自嘲的苦笑。",
    "example_jp": "嫌われたと思い過ごして一人で泣いていたが、ただの勘違いだった。",
    "example_cn": "我还多心以为自己被讨厌了，一个人躲着抹眼泪，结果完全是场误会。"
  },
  {
    "id": 715,
    "word": "見方",
    ...
    "kana": "みかた",
    "pos": "名词",
    "meaning": "看法/见解/观察角度。站在不同的立场或角度去理解事物，能够打破思维定势，让人产生茅塞顿开的解脱感。",
    "example_jp": "見方を少し変えれば、この大失敗も最高の笑い話になるじゃないか。",
    "example_cn": "稍微换个角度想，这次丢人的大失败不就成了最棒的搞笑段子吗？"
  },
  {
    "id": 716,
    "word": "殊更",
    ...
    "kana": "ことさら",
    "pos": "副词",
    "meaning": "特意/格外。故意做作地表现出某种态度，或者在众人之中尤为扎眼，带有一种刻意掩饰或突出的生硬感。",
    "example_jp": "彼女は失恋のショックを隠すように、殊更明るい声ではしゃいでいた。",
    "example_cn": "她为了掩饰失恋的打击，故意扯着嗓子，装出格外开朗的样子吵吵闹闹。"
  },
  {
    "id": 717,
    "word": "駆け引き",
    ...
    "kana": "かけひき",
    "pos": "名词",
    "meaning": "讨价还价/博弈。原指战场上的进退，现指在利益或恋爱中互相试探底线、眼神交锋、运用策略占据上风的心理战。",
    "example_jp": "商談室では、一歩も譲らないヒリヒリするような駆け引きが続いていた。",
    "example_cn": "谈判室里，双方死咬着底线不放，进行着令人神经紧绷的拉锯战。"
  },
  {
    "id": 718,
    "word": "受け継ぐ",
    ...
    "kana": "うけつぐ",
    "pos": "动词",
    "meaning": "继承/传承。将前人留下的财产、磨练的技术或精神像接力棒一样郑重接过来，双手捧着沉甸甸的责任继续前行。",
    "example_jp": "祖父から受け継いだボロボロのレシピノートは、我が家の宝物だ。",
    "example_cn": "从爷爷手里接过那本破破烂烂的秘制菜谱，它成了我们家最珍贵的传家宝。"
  },
  {
    "id": 719,
    "word": "厨房",
    ...
    "kana": "ちゅうぼう",
    "pos": "名词",
    "meaning": "厨房（尤指餐厅的）。相比家里的台所，更强调专业、繁忙、充满烟熏火燎的油烟气和暴躁指令声的压迫感。",
    "example_jp": "昼時の厨房は、怒鳴り声と鍋のぶつかる音が響く戦場のようだった。",
    "example_cn": "午餐高峰期的后厨，厨师的吼叫声和铁锅的碰撞声交织在一起，活像个战场。"
  },
  {
    "id": 720,
    "word": "淡い",
    ...
    "kana": "あわい",
    "pos": "形容词",
    "meaning": "浅/淡/微弱。不仅指颜色清淡，也指情感（如初恋）或希望极度微弱、摇摇欲坠，带有一种轻轻一碰就会碎裂的脆弱感。",
    "example_jp": "もしかして両思いかも、という淡い期待は、彼の結婚報告で打ち砕かれた。",
    "example_cn": "“说不定我们是两情相悦呢”，这种微弱的幻想被他宣布结婚的消息彻底击碎。"
  },
  {
    "id": 721,
    "word": "定まる",
    ...
    "kana": "さだまる",
    "pos": "动词",
    "meaning": "确定/稳定下来。漂浮不定的事物最终沉淀落到了实处，或是游移的视线终于找到了聚焦点，心里一块石头落地的感觉。",
    "example_jp": "彼の視線はどこか宙を泳いでいて、一向に焦点が定まらない。",
    "example_cn": "他的眼神迷离地在半空中游移，视线迟迟无法聚焦在任何东西上。"
  },
  {
    "id": 722,
    "word": "乱れ",
    ...
    "kana": "みだれ",
    "pos": "名词",
    "meaning": "混乱/紊乱。原本整齐的秩序（如头发、呼吸、心跳）被突然打乱，失去控制，陷入无序的慌张与焦躁状态。",
    "example_jp": "指先が触れた瞬間、激しい心の乱れを隠すために顔を背けた。",
    "example_cn": "指尖触碰的瞬间，为了掩饰内心剧烈的慌乱，我猛地别过了头。"
  },
  {
    "id": 723,
    "word": "茎",
    ...
    "kana": "くき",
    "pos": "名词",
    "meaning": "茎/杆。植物支撑叶子和花的骨干，折断时常伴随清脆的声响，象征着生命力努力向上挺立的紧绷感。",
    "example_jp": "太いセロリの茎をポキッと折ると、みずみずしい香りが弾けた。",
    "example_cn": "“咔嚓”一声掰断粗壮的芹菜梗，水灵灵的清香瞬间在空气中迸发出来。"
  },
  {
    "id": 724,
    "word": "当て",
    ...
    "kana": "あて",
    "pos": "名词",
    "meaning": "目标/指望。心里盘算着能依靠的人或事，一旦“当てが外れる（落空）”，就会陷入茫然四顾、手足无措的空虚感中。",
    "example_jp": "今夜泊まる当てすらなく、冷たい夜風の中をトボトボと歩き続けた。",
    "example_cn": "连今晚能在哪儿借宿都没个指望，我只能在冷风中拖着步子漫无目的地走。"
  },
  {
    "id": 725,
    "word": "火鉢",
    ...
    "kana": "ひばち",
    "pos": "名词",
    "meaning": "火盆。旧时用来烧炭取暖的器具，人们不自觉地搓着手向它靠拢，脸庞被炭火映红，带有一种怀旧的温度感。",
    "example_jp": "雪の降る夜、祖父は古びた火鉢に手をかざして、昔話を始めた。",
    "example_cn": "下雪的夜晚，爷爷把长满冻疮的手伸到旧火盆上方烤着，讲起了过去的故事。"
  },
  {
    "id": 726,
    "word": "腰掛け",
    ...
    "kana": "こしかけ",
    "pos": "名词",
    "meaning": "凳子/跳板。原指没靠背的椅子，引申为找到真正想做的事前的临时过渡，带着屁股没坐热、随时准备拍拍屁股走人的敷衍心态。",
    "example_jp": "彼はこの会社をただの腰掛けとしか思っておらず、仕事も適当だ。",
    "example_cn": "他把这家公司纯粹当成跳板，干活也是敷衍了事，根本不打算长待。"
  },
  {
    "id": 727,
    "word": "憎たらしい",
    ...
    "kana": "にくたらしい",
    "pos": "形容词",
    "meaning": "可憎的/惹人嫌的。对方傲慢的态度或戳痛处的言辞让人气血上涌，拳头攥紧，恨得牙痒痒的主观情绪。",
    "example_jp": "自分のミスを指摘してくる同期のニヤニヤした顔が、最高に憎たらしい。",
    "example_cn": "看着同期同事指出我失误时那副似笑非笑的嘴脸，真是气得我牙痒痒。"
  },
  {
    "id": 728,
    "word": "手柄",
    ...
    "kana": "てがら",
    "pos": "名词",
    "meaning": "功劳/功绩。通过流汗熬夜取得的被认可的成绩，一旦被别人轻飘飘地窃取，会产生强烈的委屈与愤怒感。",
    "example_jp": "徹夜で仕上げた企画書なのに、全部部長の手柄にされて怒りで震えた。",
    "example_cn": "明明是我熬通宵写完的企划案，功劳却全被部长抢走了，气得我浑身发抖。"
  },
  {
    "id": 729,
    "word": "仮に",
    ...
    "kana": "かりに",
    "pos": "副词",
    "meaning": "假设/假如。在脑海中搭建一个也许永远不会发生的极端情境，常常用来进行绝望中的幻想或孤注一掷的白日梦。",
    "example_jp": "仮に宝くじで一億円当たったら、明日上司の顔に辞表を叩きつけるのに。",
    "example_cn": "哪怕只是假设，要是我中了彩票头奖，明天绝对要把辞职信死死甩在老板脸上。"
  },
  {
    "id": 730,
    "word": "数〜",
    ...
    "kana": "すう〜",
    "pos": "接头词",
    "meaning": "几……/数……。加在量词前表示不确定的少量，这种模糊感反而拉长了等待的时间，积压出一种漫长或疲惫的沉重感。",
    "example_jp": "氷雨が降る中、数時間も彼女を待ち続けたが、結局姿を見せなかった。",
    "example_cn": "在冰冷刺骨的雨中苦等了几个小时，直到腿都站僵了，她最终还是没有出现。"
  },
  {
    "id": 731,
    "word": "物別れ",
    ...
    "kana": "ものわかれ",
    "pos": "名词",
    "meaning": "破裂/未达成协议。激烈的谈判没有结果，双方阴沉着脸推开椅子，带着各自的挫败感背道而驰、不欢而散。",
    "example_jp": "三時間も机を叩いて激論を交わしたが、結局交渉は物別れに終わった。",
    "example_cn": "拍着桌子激烈争论了三个小时，谈判最终还是谈崩了，大家阴沉着脸不欢而散。"
  },
  {
    "id": 732,
    "word": "雨脚",
    ...
    "kana": "あまあし",
    "pos": "名词",
    "meaning": "雨势/雨丝。形容雨下落的连线或速度，像雨有了脚一样向人逼近，表现雨越来越猛烈、砸在身上发疼的压迫感。",
    "example_jp": "突然雨脚が強まり、アスファルトを激しく打ちつける音が響き渡った。",
    "example_cn": "雨势突然变猛，豆大的雨点狠狠砸在柏油马路上，溅起水花并发出震耳的响声。"
  },
  {
    "id": 733,
    "word": "決まり文句",
    ...
    "kana": "きまりもんく",
    "pos": "名词",
    "meaning": "客套话/老一套。总是重复出现、毫无新意的话，听的人不自觉地翻白眼，耳朵都生茧了的敷衍和无奈。",
    "example_jp": "「電車が遅延して」という彼の言い訳は、もはや聞き飽きた決まり文句だ。",
    "example_cn": "他那句“电车晚点了”的借口，已经是听得我翻白眼、耳朵起茧子的老一套了。"
  },
  {
    "id": 734,
    "word": "飛び入り",
    ...
    "kana": "とびいり",
    "pos": "名词",
    "meaning": "临时参加/中途加入。没有提前报名，看气氛热烈一时兴起就插一脚，带有一种不管不顾打破常规的热闹与随性。",
    "example_jp": "酔っ払ったおじさんが、ストリートライブに飛び入り参加して熱唱し始めた。",
    "example_cn": "一个喝醉的大叔中途兴冲冲地挤进街头表演的队伍里，抓起麦克风就开始狂唱。"
  },
  {
    "id": 735,
    "word": "乙",
    ...
    "kana": "おつ",
    "pos": "名词/形容动词",
    "meaning": "别有风味/奇特。常形容稍微有些小众或古怪，但细细品味又觉得非常有情调的东西，带着一种内行人的自得其乐。",
    "example_jp": "凍えるような雪景色を見ながら、熱燗をちびちびやるのも乙なものだ。",
    "example_cn": "望着冻人的雪景，缩着脖子小口小口地抿着热清酒，倒也别有一番风味。"
  },
  {
    "id": 736,
    "word": "恵む",
    ...
    "kana": "めぐむ",
    "pos": "动词",
    "meaning": "施舍/恩赐。居高临下地把财物扔给弱者，接受方不仅没有喜悦，反而会感到自尊被践踏的屈辱与咬牙切齿。",
    "example_jp": "「小銭でも恵んでやろうか」と見下すように投げられた硬貨を、私は無視した。",
    "example_cn": "“施舍你点零钱吧”，看着他满脸轻蔑扔在地上的硬币，我咬着牙扭过了头。"
  },
  {
    "id": 737,
    "word": "持ち去る",
    ...
    "kana": "もちさる",
    "pos": "动词",
    "meaning": "拿走/带走。未经允许强行把东西连根拔起转移走，原处只剩下一片空虚，给人留下被猛烈掠夺的震惊与愤怒。",
    "example_jp": "泥棒は窓ガラスを割り、机の上のノートパソコンをまるごと持ち去っていた。",
    "example_cn": "小偷砸碎了窗玻璃，把书桌上的笔记本电脑整个儿顺走了，只留下一地碎渣。"
  },
  {
    "id": 738,
    "word": "煙る",
    ...
    "kana": "けむる",
    "pos": "动词",
    "meaning": "冒烟/烟雾弥漫。烟雾缭绕熏得人眯起眼睛，或指雨水雾气让眼前的景色变得模模糊糊，产生一种凄迷不清的氛围。",
    "example_jp": "焼肉の脂で盛大に煙る店内で、目をショボショボさせながら肉をつついた。",
    "example_cn": "烤肉滋滋冒油，整个店里被熏得乌烟瘴气，我只能半眯着眼睛夹肉吃。"
  },
  {
    "id": 739,
    "word": "手厚い",
    ...
    "kana": "てあつい",
    "pos": "形容词",
    "meaning": "优厚的/热情的。招待或护理等极其周到、尽心尽力，超出了预期的标准，让人感到手足无措的受宠若惊。",
    "example_jp": "田舎の親戚の家で、食べきれないほどのご馳走と手厚いもてなしを受けた。",
    "example_cn": "在乡下亲戚家受到了无比热情的款待，满桌子根本吃不完的好菜让我受宠若惊。"
  },
  {
    "id": 740,
    "word": "痩せ我慢",
    ...
    "kana": "やせがまん",
    "pos": "名词",
    "meaning": "死撑/打肿脸充胖子。明明很痛苦、发抖或没钱，却硬挺着脊背在别人面前装作若无其事，透着一股心酸的倔强。",
    "example_jp": "薄着でガタガタ震えながら、「全然寒くないよ」と痩せ我慢をして微笑んだ。",
    "example_cn": "我身上穿着单衣冻得直打哆嗦，却还是死撑着挤出笑容说“一点儿都不冷”。"
  },
  {
    "id": 741,
    "word": "駒",
    ...
    "kana": "こま",
    "pos": "名词",
    "meaning": "棋子/工具。原指将棋的棋子，引申为被人无情操纵、榨干价值后随意丢弃的工具人，充满没有自主权的悲哀。",
    "example_jp": "結局、自分は会社の上層部にとって、いつでも捨てられるただの駒だったんだ。",
    "example_cn": "搞了半天，对公司高层来说，我也只不过是一颗随时可以被一脚踢开的棋子罢了。"
  },
  {
    "id": 742,
    "word": "商う",
    ...
    "kana": "あきなう",
    "pos": "动词",
    "meaning": "做买卖/经商。不是在高楼大厦里办公，而更像是在简陋的店铺里摆弄商品、弯腰招揽客人的小本经营，透着市井的辛劳。",
    "example_jp": "腰の曲がったお婆さんが、路地裏の小さな店で細々と野菜を商っている。",
    "example_cn": "驼背的老奶奶守在小巷子里的破旧门面里，守着几筐青菜辛苦地做着小本买卖。"
  },
  {
    "id": 743,
    "word": "擦れ擦れ",
    ...
    "kana": "すれすれ",
    "pos": "形容动词/副词",
    "meaning": "几乎擦到/险些。物体之间只差毫厘就要撞上，或者处于随时会掉下去的危险边缘，让人瞬间倒吸一口凉气、捏把汗。",
    "example_jp": "スピード違反の車が、私のサイドミラーと擦れ擦れの間隔で通り抜けていった。",
    "example_cn": "一辆超速的车猛地窜过，几乎是贴着我的后视镜擦过去的，吓出我一身冷汗。"
  },
  {
    "id": 744,
    "word": "耐える",
    ...
    "kana": "たえる",
    "pos": "动词",
    "meaning": "忍耐/经受得住。神经紧绷到极点，咬紧牙关承受着巨大的物理痛苦或精神压力，硬抗到底绝不崩溃的坚忍姿态。",
    "example_jp": "激しい腹痛に顔をしかめ、冷や汗を流しながら、ただ薬が効くのを耐えて待った。",
    "example_cn": "痛得我五官都扭曲了，冷汗直冒，只能死咬着牙硬挺着，等止痛药起效。"
  },
  {
    "id": 745,
    "word": "勢ぞろい",
    ...
    "kana": "せいぞろい",
    "pos": "名词/动词",
    "meaning": "齐聚一堂/阵容鼎盛。平时散落各处、很难凑齐的人或物乌压压地全部排开聚集在一起，气势磅礴得让人感到震撼或压抑。",
    "example_jp": "遺産相続の話し合いのため、犬猿の仲の親戚たちが応接間に勢ぞろいした。",
    "example_cn": "为了争夺遗产，平时水火不容的亲戚们竟齐刷刷地坐在了客厅里，气氛压抑极了。"
  },
  {
    "id": 746,
    "word": "未だに",
    ...
    "kana": "いまだに",
    "pos": "副词",
    "meaning": "至今仍然。随着漫长的时间流逝，早就该被淘汰或改变的事情却固执地原封不动，常伴随着无可奈何的叹息。",
    "example_jp": "周りが全員スマホなのに、父は未だにボロボロのガラケーを大事に使っている。",
    "example_cn": "身边的人全换了智能机，我爸竟然至今还在拿当宝贝似的捧着那个掉漆的翻盖手机。"
  },
  {
    "id": 747,
    "word": "殿",
    ...
    "kana": "との",
    "pos": "名词",
    "meaning": "老爷/最后尾。古代对贵族的尊称，现在多指队伍逃跑时留在最后方（殿を務める），一个人独自面对追兵的悲壮与决绝。",
    "example_jp": "負傷した仲間を逃がすため、彼一人で追手の前に立ち塞がり殿を務めた。",
    "example_cn": "为了让受伤的同伴安全撤退，他孤身一人挡在追兵面前，死死守住了队伍的最后方。"
  },
  {
    "id": 748,
    "word": "言い損なう",
    ...
    "kana": "いいそこなう",
    "pos": "动词",
    "meaning": "没说出口/说错。话已经到了嘴边却硬生生咽了下去，错失了最后的时机，事后一个人抓着头发陷入深深的懊悔。",
    "example_jp": "発車ベルが鳴り響く中、ずっと隠していた「好き」という言葉を言い損なった。",
    "example_cn": "伴随着刺耳的发车铃声，那句一直藏在心底的“我喜欢你”，最终还是被我咽了回去。"
  },
  {
    "id": 749,
    "word": "充てる",
    ...
    "kana": "あてる",
    "pos": "动词",
    "meaning": "充当/拨给。把有限的金钱或资源像塞积木一样精准地填补到某个特定的缺口上，有种精打细算甚至拆东墙补西墙的紧迫感。",
    "example_jp": "待ちに待ったボーナスは、その日のうちに全額借金の返済に充てられた。",
    "example_cn": "苦盼了好久的年终奖一发下来，当天就被我全砸进去填补债务的窟窿了。"
  },
  {
    "id": 750,
    "word": "家出",
    ...
    "kana": "いえで",
    "pos": "名词/动词",
    "meaning": "离家出走。带着对家庭的愤怒或绝望，胡乱抓起几件衣服摔门而出，充满着青春期的叛逆、冲动与决绝。",
    "example_jp": "父親と大喧嘩した夜、リュックに服だけを詰め込んで、勢いよく家出をした。",
    "example_cn": "和父亲大吵一架的那天夜里，我胡乱往双肩包里塞了几件衣服，摔门离家出走了。"
  },
  {
    "id": 751,
    "word": "なりたつ",
    ...
    "kana": "なりたつ",
    "pos": "自動詞",
    "meaning": "成立/构成。由多个要素拼合达到稳固的状态。从“形成”并“站立”引申为逻辑或结构站得住脚。仿佛几块积木咔嗒一声严丝合缝地卡紧，不再摇晃。",
    "example_jp": "彼の曖昧な証言だけでは、とても犯罪の立証は成り立たないよ。",
    "example_cn": "光靠他那含糊其辞的证词，根本无法把这起犯罪的指控给做实啊。"
  },
  {
    "id": 752,
    "word": "よふけ",
    ...
    "kana": "よふけ",
    "pos": "名詞",
    "meaning": "深夜/半夜。夜色逐渐加深、万物沉静的时段。“更け”带有时间推移、夜色越来越浓的动态感。四周漆黑，只剩墙上的时钟在滴答作响。",
    "example_jp": "夜更けの鳴り響く電話は、いつも胸がざわついて嫌な予感がする。",
    "example_cn": "深夜里突然响起的刺耳电话铃声，总让人心里发毛，有种不祥的预感。"
  },
  {
    "id": 753,
    "word": "うれえる",
    ...
    "kana": "うれえる",
    "pos": "他動詞",
    "meaning": "担忧/忧虑。因对未来或现状感到不安而心情沉重。眉头紧锁，眼神黯淡，胸口仿佛压着一块挥之不去的阴霾。",
    "example_jp": "窓の外の荒れ狂う海を見つめ、彼は村の将来を深く憂えた。",
    "example_cn": "他凝视着窗外波涛汹涌的大海，眉头紧锁，对村庄的未来忧心忡忡。"
  },
  {
    "id": 754,
    "word": "こころがける",
    ...
    "kana": "こころがける",
    "pos": "他動詞",
    "meaning": "留意/用心。把某事悬在心头，在日常行动中刻意去约束和实践。“心”悬挂在某处，犹如脑子里时刻绷着一根弦，审视自己的动作是否越界。",
    "example_jp": "感情的になりそうな時ほど、わざとゆっくり話すよう心がけている。",
    "example_cn": "每当感觉自己快要情绪失控时，我都会暗自提醒自己，刻意把语速放慢下来。"
  },
  {
    "id": 755,
    "word": "のりこむ",
    ...
    "kana": "のりこむ",
    "pos": "自動詞",
    "meaning": "乘上/气势汹汹地进入。不仅是坐进交通工具，常带有主动、甚至带有某种敌意或气势跨入某个场地的动态。重重地踏入车厢或一把推开大门，带着不可阻挡的冲劲。",
    "example_jp": "怒り狂った社長が、いきなり開発部の会議室に乗り込んできた。",
    "example_cn": "暴怒的总经理一把推开大门，气势汹汹地冲进了开发部的会议室。"
  },
  {
    "id": 756,
    "word": "くみこむ",
    ...
    "kana": "くみこむ",
    "pos": "他動詞",
    "meaning": "编入/纳入。将某个部件或要素嵌入到一个已有的整体框架中。“組む”代表交织，“込む”代表深入内部。像拼图一样严丝合缝地塞进卡槽里。",
    "example_jp": "毎朝の軽いジョギングを、なんとか一日のルーティンに組み込みたい。",
    "example_cn": "我想方设法也要把每天早上的慢跑，硬塞进我雷打不动的日程表里。"
  },
  {
    "id": 757,
    "word": "ひょうへん",
    ...
    "kana": "ひょうへん",
    "pos": "名詞/自動詞",
    "meaning": "突然改变态度。态度或性格发生了如同豹子褪去旧毛换上新斑纹般剧烈的翻转。多指往坏的方向，前一秒还笑盈盈，下一秒眼神冰冷如霜。",
    "example_jp": "渋滞にはまった途端、あの温厚な先輩が人が変わったように豹変した。",
    "example_cn": "车子刚一堵在路上，那位原本温和厚道的前辈瞬间就像换了个人似的，暴躁得可怕。"
  },
  {
    "id": 758,
    "word": "ひのけ",
    ...
    "kana": "ひのけ",
    "pos": "名詞",
    "meaning": "烟火气/火源。能让人感受到火的温暖或燃烧迹象的气息。常用于描述寒冷无人的空间缺乏取暖设施时的冷清。冰冷的房间里哈气成霜，找不到半点暖意。",
    "example_jp": "火の気のない真冬の体育館は、足の裏から芯まで冷え切る。",
    "example_cn": "隆冬时节没有半点火炉暖气的体育馆里，寒意顺着脚底板直逼骨髓。"
  },
  {
    "id": 759,
    "word": "しきたり",
    ...
    "kana": "しきたり",
    "pos": "名詞",
    "meaning": "规矩/惯例。自古流传下来、大家都在默默遵守的传统做法。常带有一定束缚感和不可违抗的陈旧气息。人们低着头，按照祖辈画好的线机械地走着。",
    "example_jp": "古い仕来たりに縛られたこの町では、よそ者はいつも息が詰まる。",
    "example_cn": "在这座被陈规陋习死死捆绑的小镇里，外乡人总是被压抑得喘不过气来。"
  },
  {
    "id": 760,
    "word": "みもと",
    ...
    "kana": "みもと",
    "pos": "名詞",
    "meaning": "身份/来历。一个人的出身、背景或过去的经历。“身”的“元（根源）”，即这个人从哪来。拿着放大镜在档案袋里翻找蛛丝马迹。",
    "example_jp": "倒れていた男のポケットには、身元を証明するものは一切なかった。",
    "example_cn": "那个倒在地上的男人，口袋里被翻了个底朝天，却找不到任何能证明他来历的物件。"
  },
  {
    "id": 761,
    "word": "とりにく",
    ...
    "kana": "とりにく",
    "pos": "名詞",
    "meaning": "禽肉/鸡肉。主要指作为食材的鸡肉。生鲜超市的冷柜里切好、泛着淡粉色光泽的带皮生肉块。",
    "example_jp": "特売の鳥肉を買い込んで、今夜は山盛りの唐揚げを作ろう。",
    "example_cn": "趁着特价抢购了一大堆鸡肉，今晚要在餐桌上炸出一座小山一样的炸鸡块。"
  },
  {
    "id": 762,
    "word": "いたむ",
    ...
    "kana": "いたむ",
    "pos": "他動詞",
    "meaning": "哀悼/悼念。因为他人的逝去而内心感到悲痛。“痛む”的同源词，强调心头如同被割裂般的刺痛感。身穿黑衣，低垂着眼眸，在墓前默默献上一束白花。",
    "example_jp": "突然の悲報に接し、誰もが言葉を失って親友の死を深く悼んだ。",
    "example_cn": "听到这突如其来的噩耗，所有人都震惊得说不出话来，沉浸在痛失挚友的悲哀中。"
  },
  {
    "id": 763,
    "word": "おしえご",
    ...
    "kana": "おしえご",
    "pos": "名詞",
    "meaning": "学生/弟子。自己亲自教导过的学生，带有长辈对晚辈的关护和亲昵感。相比“生徒”，更强调师生间建立过的情感羁绊。看着从前那个懵懂的孩子如今独当一面。",
    "example_jp": "かつての教え子が立派な医者になって戻ってきた時、思わず涙ぐんだ。",
    "example_cn": "看到昔日那个笨拙的学生如今穿着白大褂堂堂正正地回来时，我不禁眼眶一热。"
  },
  {
    "id": 764,
    "word": "ふいうち",
    ...
    "kana": "ふいうち",
    "pos": "名詞",
    "meaning": "偷袭/出其不意。趁对方毫无防备时突然发动的打击或行动。毫无预兆地在背后挨了一记闷棍，或者突然被点名时的惊慌失措。",
    "example_jp": "会議の終盤での不意打ちの質問に、彼は一瞬完全に言葉に詰まった。",
    "example_cn": "在会议快结束时突然被杀了个回马枪提问，他一下子慌了神，半天没憋出一句话。"
  },
  {
    "id": 765,
    "word": "みぐるしい",
    ...
    "kana": "みぐるしい",
    "pos": "形容詞",
    "meaning": "难看的/丢脸的。样子或行为丑陋难堪，让人看了觉得碍眼或不舒服。“見”起来非常“苦”。由于死皮赖脸或极度狼狈，让旁观者都替他尴尬得脚趾抓地。",
    "example_jp": "負けを認めず審判に食ってかかるなんて、本当に見苦しい真似だ。",
    "example_cn": "输了死不认账，还红着脖子去跟裁判大吵大闹，这副嘴脸实在太难看了。"
  },
  {
    "id": 766,
    "word": "はやまる",
    ...
    "kana": "はやまる",
    "pos": "自動詞",
    "meaning": "提前/草率行事。时间上比预期提前，或因为慌乱而做出欠考虑的决定。“早”过了头，导致脚步踉跄走错路。脑子一热，不顾后果地按下了发送键。",
    "example_jp": "早まって辞表を叩きつける前に、もう少し冷静に状況を見極めろ。",
    "example_cn": "在你头脑发热冲动摔辞职信之前，先给我冷静下来，好好掂量掂量眼前的局势！"
  },
  {
    "id": 767,
    "word": "かさばる",
    ...
    "kana": "かさばる",
    "pos": "自動詞",
    "meaning": "体积大/占地方。重量可能不重，但体积膨大，导致收纳或携带非常碍事。试图把一件蓬松的羽绒服硬塞进行李箱，拉链怎么也拉不上。",
    "example_jp": "冬服はスーツケースの中でどうしても嵩張るから、荷造りが憂鬱だ。",
    "example_cn": "冬天的衣服塞在行李箱里死活压不平、极其占地方，一想到要打包行李我就头疼。"
  },
  {
    "id": 768,
    "word": "かんぐる",
    ...
    "kana": "かんぐる",
    "pos": "他動詞",
    "meaning": "瞎猜/多心。凭借微小的线索，主观地往坏的方面揣测别人的意图。“勘（直觉）”不断打转。眯起眼睛，心里暗暗盘算对方是不是话里有话。",
    "example_jp": "上司が急に優しくなったので、裏に何かあるのではと勘ぐってしまった。",
    "example_cn": "老板今天破天荒地对我这么和颜悦色，我不禁心里直打鼓，瞎猜他背后是不是憋着什么坏水。"
  },
  {
    "id": 769,
    "word": "しるす",
    ...
    "kana": "しるす",
    "pos": "他動詞",
    "meaning": "记载/铭记。将文字写下来留下记录，或将记忆深深印在脑海中。用笔尖在厚重的纸页上郑重地刻写下每一个字，或是闭上眼把画面刻进心里。",
    "example_jp": "古びたノートには、彼が若き日に抱いた熱い思いがびっしり記されていた。",
    "example_cn": "那本泛黄卷边的笔记本上，密密麻麻地写满了他年轻时满腔热血的抱负。"
  },
  {
    "id": 770,
    "word": "したっぱ",
    ...
    "kana": "したっぱ",
    "pos": "名詞",
    "meaning": "底层人员/小喽啰。在组织或团体中地位最低、负责跑腿打杂的人。在阴暗的角落里弯着腰、端茶倒水看人脸色行事的底层小人物。",
    "example_jp": "俺みたいな下っ端が口を出せるような、生易しい問題じゃないんだ。",
    "example_cn": "这水深得很，根本不是我这种在底层跑腿的小喽啰有资格插嘴的事儿。"
  },
  {
    "id": 771,
    "word": "ちんさげ",
    ...
    "kana": "ちんさげ",
    "pos": "名詞",
    "meaning": "降薪/降低工资。削减劳动者的薪酬。工资条上的数字被无情划掉改小，员工们看着账单眉头紧缩、唉声叹气。",
    "example_jp": "突然の賃下げ通告に、社員たちは怒りと不安でざわめき立った。",
    "example_cn": "面对突如其来的降薪通知，员工们顿时炸开了锅，脸上写满了愤怒与惶恐。"
  },
  {
    "id": 772,
    "word": "かんにんぶくろ",
    ...
    "kana": "かんにんぶくろ",
    "pos": "名詞",
    "meaning": "忍耐的限度。想象心中有一个专门装“忍”字的袋子。当愤怒积攒到顶点，袋子被彻底撑破。紧攥的双拳微微发抖，最后神经“啪”地断裂。",
    "example_jp": "何度も約束を破られ、ついに私の堪忍袋の緒が切れた。",
    "example_cn": "被他三番五次地放鸽子，我脑子里那根叫做忍耐的弦终于“啪”地断了，怒火彻底爆发。"
  },
  {
    "id": 773,
    "word": "わがはい",
    ...
    "kana": "わがはい",
    "pos": "代名詞",
    "meaning": "我（自大/戏谑）。带有旧时代感、自视甚高或略带滑稽色彩的第一人称代词。因为《我是猫》而广为人知。挺起胸膛，双手背在身后，故作威严地清嗓子。",
    "example_jp": "我が輩の辞書に不可能という文字はないと、彼は偉そうに胸を張った。",
    "example_cn": "他得意洋洋地挺起胸膛，摇头晃脑地说着“本大爷的字典里就没‘不可能’这三个字”。"
  },
  {
    "id": 774,
    "word": "かけら",
    ...
    "kana": "かけら",
    "pos": "名詞",
    "meaning": "碎片/微小的一点。物体碎裂后的小块，或比喻某种情感、特质连最微小的一丁点都没有了。掉落在地上闪着寒光的玻璃渣，或者空空如也的心底。",
    "example_jp": "散々嘘をつかれたのに、彼への未練の欠片がまだ胸の奥に残っている。",
    "example_cn": "明明被他骗得团团转，可心底深处却依然残留着那么一丁点儿剪不断理还乱的眷恋。"
  },
  {
    "id": 775,
    "word": "かたてま",
    ...
    "kana": "かたてま",
    "pos": "名詞",
    "meaning": "业余时间/顺便。在做主要工作的间隙，顺便做另一件事。一只手（片手）还在忙正事，用剩余的精力去应付别的。眼睛盯着屏幕打字，另一只手在盲拼魔方。",
    "example_jp": "育児の片手間に始めたブログが、いつの間にか本業以上の収入になった。",
    "example_cn": "趁着带娃的空隙随手写的博客，不知不觉间赚的钱居然比我本职工作还要多了。"
  },
  {
    "id": 776,
    "word": "したてる",
    ...
    "kana": "したてる",
    "pos": "他動詞",
    "meaning": "缝制/假装成。把布料做成衣服，引申为刻意伪装或捏造出一个特定身份。一针一线地缝合，或者在幕后精心为某人套上虚假的人设外衣。",
    "example_jp": "彼はただの事故を、まるで仕組まれた殺人事件のように仕立て上げた。",
    "example_cn": "他硬生生地把一场普通的意外，添油加醋地捏造成了一起蓄谋已久的谋杀案。"
  },
  {
    "id": 777,
    "word": "めんじる",
    ...
    "kana": "めんじる",
    "pos": "他動詞",
    "meaning": "免除/看在…的情面上原谅。免去职务，或因为某个因素（过去的功劳或某人的面子）而网开一面。叹了口气，把高举的鞭子又放了下来。",
    "example_jp": "彼のこれまでの功績に免じて、今回の大失敗は特別に不問に付す。",
    "example_cn": "看在他过去立下汗马功劳的份上，上面决定对他这次捅出的大娄子网开一面，不再追究。"
  },
  {
    "id": 778,
    "word": "ちゃのゆ",
    ...
    "kana": "ちゃのゆ",
    "pos": "名詞",
    "meaning": "茶道。日本传统的点茶、品茶的礼仪与艺术体系。包含禅意、器具、礼法的一整套空间体验。在幽静的茶室里，听着水沸腾的微小声音，专注地搅动茶筅。",
    "example_jp": "静寂な茶室で茶の湯の作法に触れ、日頃のストレスが洗われる気がした。",
    "example_cn": "置身于幽静的茶室中体验茶道的繁复礼节，感觉日常积压的压力都被洗涤了一番。"
  },
  {
    "id": 779,
    "word": "げん〜",
    ...
    "kana": "げん〜",
    "pos": "接頭辞",
    "meaning": "现任的/现在的。附加在头衔或事物前，表示目前正处于该职位或该状态。名字前面挂着闪闪发光或沉甸甸的当前头衔牌。",
    "example_jp": "現社長の強引な経営方針には、古参の役員たちから強い反発が出ている。",
    "example_cn": "现任总裁提出的大刀阔斧的经营方针，惹得那些元老级的高管们吹胡子瞪眼地强烈反对。"
  },
  {
    "id": 780,
    "word": "ちゃかす",
    ...
    "kana": "ちゃかす",
    "pos": "他動詞",
    "meaning": "打趣/敷衍过去。把别人认真说的话或严肃的场合，用开玩笑的方式糊弄过去。为了掩饰尴尬或不想面对，故意发出轻浮的笑声转移话题。",
    "example_jp": "真剣に悩みを打ち明けたのに、笑って茶化されて無性に腹が立った。",
    "example_cn": "我满心沉重地向他倾诉烦恼，他却嘻皮笑脸地给我打哈哈糊弄过去，真让人火大。"
  },
  {
    "id": 781,
    "word": "なりゆき",
    ...
    "kana": "なりゆき",
    "pos": "名詞",
    "meaning": "事态的发展/趋势。事情自然而然演变的过程。“成る”和“行く”，事态像河流一样顺势往前淌，人只能被裹挟其中。双手插兜，看着事态自己滚动。",
    "example_jp": "もう俺たちにできる事はない、あとは事の成り行きを静かに見守るだけだ。",
    "example_cn": "我们现在已经是计无所出了，剩下的就只能眼睁睁地看着事情自己顺其自然地发展了。"
  },
  {
    "id": 782,
    "word": "みはる",
    ...
    "kana": "みはる",
    "pos": "他動詞",
    "meaning": "监视/睁大眼睛。紧紧盯着某处以防发生意外；或因为惊奇而把眼睛瞪得圆圆的。眼睛像探照灯一样扫射不放过任何死角，或者眼珠子因为震惊快要掉出来。",
    "example_jp": "彼女の目を見張るような上達ぶりに、厳しいコーチも言葉を失っていた。",
    "example_cn": "看着她那令人瞠目结舌的飞速进步，连一向苛刻的教练都震惊得说不出话来。"
  },
  {
    "id": 783,
    "word": "あともどり",
    ...
    "kana": "あともどり",
    "pos": "名詞/自動詞",
    "meaning": "倒退/半途而废。走到一半又退回原点，或者事态恶化回到了之前的状态。在雪地里艰难跋涉了一半，又无奈地踩着自己的脚印往回走。",
    "example_jp": "ここまでプロジェクトが進んだ以上、もう絶対に後戻りはできないぞ。",
    "example_cn": "既然项目已经砸钱推进到这个地步了，咱们可是被逼上梁山，再也没有回头路可走了。"
  },
  {
    "id": 784,
    "word": "むりじい",
    ...
    "kana": "むりじい",
    "pos": "名詞/他動詞",
    "meaning": "强迫/勉强。无视对方的意愿，强行让其做某事。“無理”地“強いる”。硬把酒杯塞到对方手里，或者按着别人的头逼其低头。",
    "example_jp": "嫌がる子供に習い事を無理強いしても、結局は何も身につかないよ。",
    "example_cn": "就算你按着牛头强迫那个一百个不愿意的孩子去上兴趣班，到头来也是什么都学不进去的。"
  },
  {
    "id": 785,
    "word": "しくみ",
    ...
    "kana": "しくみ",
    "pos": "名詞",
    "meaning": "结构/机制。事物内部互相咬合、运作的构造或计划。像拆开一块怀表，看到里面密密麻麻、精准咬合运转的齿轮和发条。",
    "example_jp": "この詐欺は、被害者が自らお金を振り込むような巧妙な仕組みになっている。",
    "example_cn": "这个诈骗套路设计得极其阴险狡猾，一环扣一环，引诱着受害者神使鬼差地自己把钱打过去。"
  },
  {
    "id": 786,
    "word": "おもてむき",
    ...
    "kana": "おもてむき",
    "pos": "名詞/副詞",
    "meaning": "表面上/公开地。对外宣称的、摆在台面上的理由或状态，暗示背后另有隐情。一张画着笑脸的面具，背后却是一张阴沉算计的脸。",
    "example_jp": "表向きは円満退社ということになっているが、実際は横領でのクビだ。",
    "example_cn": "对外虽然冠冕堂皇地宣称是和平离职，但大家心知肚明，他其实是因为贪污被扫地出门的。"
  },
  {
    "id": 787,
    "word": "みつもる",
    ...
    "kana": "みつもる",
    "pos": "他動詞",
    "meaning": "估算/评估。提前预测并计算所需的时间、金钱或规模。手里拿着计算器和卷尺，眯着眼睛在心里盘算各种变量和损耗。",
    "example_jp": "修理費用を甘く見積もっていたせいで、月末の生活費が完全に底をついた。",
    "example_cn": "都怪我一开始把修车的钱算得太乐观，结果现在月末只能眼巴巴看着钱包见底，干瞪眼了。"
  },
  {
    "id": 788,
    "word": "きずつく",
    ...
    "kana": "きずつく",
    "pos": "自動詞",
    "meaning": "受伤/自尊心受挫。物品表面留下划痕，或人的内心遭到打击而痛苦。玻璃上突然多了一道裂纹，或者胸口像被针猛地扎了一下，黯然神伤。",
    "example_jp": "何気ない彼の一言に深く傷つき、布団の中で一晩中涙が止まらなかった。",
    "example_cn": "他那句漫不经心的话像刀子一样深深刺痛了我，让我裹在被子里流了整整一宿的眼泪。"
  },
  {
    "id": 789,
    "word": "きわまる",
    ...
    "kana": "きわまる",
    "pos": "自動詞",
    "meaning": "极其/到了极点。达到某种状态的极限，无法再进一步了。多用于消极情绪或极端状态。犹如被逼到了悬崖最边缘，脚跟已经悬空。",
    "example_jp": "あんな大勢の前で大転倒するなんて、恥ずかしさ極まって穴があったら入りたい。",
    "example_cn": "竟然在那么多人面前摔了个底朝天，我真是尴尬到了极点，恨不得当场刨个地缝钻进去。"
  },
  {
    "id": 790,
    "word": "ふえ",
    ...
    "kana": "ふえ",
    "pos": "名詞",
    "meaning": "笛子/哨子。吹奏发声的管乐器或警示用的哨子。放在嘴边用力一吹，发出清脆刺耳或悠扬婉转的声音。",
    "example_jp": "審判の甲高い笛の音がピピッと響き、運命の試合の幕が切って落とされた。",
    "example_cn": "随着裁判吹响那声尖锐刺耳的哨声，这场决定命运的生死战正式拉开了帷幕。"
  },
  {
    "id": 791,
    "word": "すべ",
    ...
    "kana": "すべ",
    "pos": "名詞",
    "meaning": "方法/手段。为了解决某事或摆脱困境而采取的具体对策。常与“没有”连用。面对着一堵高墙，双手绝望地在墙上摸索，却找不到一丝缝隙。",
    "example_jp": "連絡先も分からない今となっては、彼女に謝る術はもう何一つ残されていない。",
    "example_cn": "事到如今，连她的联系方式都弄丢了，我哪怕想去赔个不是也彻底无计可施了。"
  },
  {
    "id": 792,
    "word": "やすらぎ",
    ...
    "kana": "やすらぎ",
    "pos": "名詞",
    "meaning": "安宁/平静。身心彻底放松、没有不安与压力的舒适状态。卸下千斤重担，像陷进柔软的沙发里，长长地舒了一口气。",
    "example_jp": "激務を終え、愛犬の無防備な寝顔を見ている時だけが私の唯一の安らぎだ。",
    "example_cn": "熬过繁重的工作后，唯有静静地看着爱犬毫无防备的睡颜，我紧绷的神经才能得到片刻的安宁。"
  },
  {
    "id": 793,
    "word": "きゅうきょ",
    ...
    "kana": "きゅうきょ",
    "pos": "副詞",
    "meaning": "仓促/急忙。原本没有计划，因为突发状况而慌慌张张地临时改变决定。接到一通电话后脸色大变，抓起外套跌跌撞撞地冲出门。",
    "example_jp": "主演俳優が倒れたため、急遽代役を立ててなんとか公演を行うことになった。",
    "example_cn": "因为主演突然晕倒在后台，剧组只能慌忙拉个替补演员顶上去，硬着头皮开演。"
  },
  {
    "id": 794,
    "word": "まさしく",
    ...
    "kana": "まさしく",
    "pos": "副詞",
    "meaning": "的确/正是。毫无疑问，完全符合某种预测或事实。手指着某个目标，笃定地重重点头。拨开迷雾，真相大白时的确凿感。",
    "example_jp": "カメラに映るその不審な男は、正しく指名手配中の連続強盗犯だった。",
    "example_cn": "监控探头里拍到的那个鬼鬼祟祟的男人，毫无疑问，正是那个被通缉的连环抢劫犯！"
  },
  {
    "id": 795,
    "word": "はらごしらえ",
    ...
    "kana": "はらごしらえ",
    "pos": "名詞/自動詞",
    "meaning": "垫肚子/饭前准备。在做消耗体力的事情前先吃点东西填饱肚子。挽起袖子前，先大口扒个饭团把空虚的胃填满以蓄力。",
    "example_jp": "地獄の徹夜作業に備えて、まずはラーメンでも食って腹ごしらえしようぜ。",
    "example_cn": "马上就要面临地狱般的通宵爆肝了，咱们先去嗦碗拉面垫垫肚子、蓄蓄体力吧！"
  },
  {
    "id": 796,
    "word": "おとろえる",
    ...
    "kana": "おとろえる",
    "pos": "自動詞",
    "meaning": "衰退/衰弱。力量或气势随着时间推移逐渐下降，大不如前。曾经茂盛的树叶干枯发黄无力飘落；曾经健步如飞的腿现在步履蹒跚。",
    "example_jp": "祖父は最近めっきり足腰が衰え、数段の階段を上るのも辛そうになった。",
    "example_cn": "爷爷最近腿脚明显衰弱得厉害，连爬几级楼梯都气喘吁吁、颤颤巍巍的，看着真让人心酸。"
  },
  {
    "id": 797,
    "word": "とびきり",
    ...
    "kana": "とびきり",
    "pos": "副詞",
    "meaning": "特别/出众。在同类事物中远超一般水平，脱颖而出。“飛ぶ”出“切り（限度）”。就像在一堆灰暗的石头里突然跃出一颗闪瞎眼的钻石。",
    "example_jp": "彼女の誕生日に、飛び切り上等なヴィンテージワインを奮発して開けた。",
    "example_cn": "借着她过生日的由头，我一咬牙狠下心，开了一瓶绝顶高档的年份红酒来庆祝。"
  },
  {
    "id": 798,
    "word": "あまやどり",
    ...
    "kana": "あまやどり",
    "pos": "名詞/自動詞",
    "meaning": "避雨。为了躲避突然下起来的雨，暂时停留在遮蔽处。双手护在头顶，一路小跑冲进便利店的屋檐下，拍打着肩膀上的水珠。",
    "example_jp": "突然の土砂降りに見舞われ、近くの寂れた神社で雨宿りをする羽目になった。",
    "example_cn": "猝不及防地被倾盆大雨浇了个透心凉，我只好钻进附近一座破败的神社里狼狈地避雨。"
  },
  {
    "id": 799,
    "word": "すみこむ",
    ...
    "kana": "すみこむ",
    "pos": "自動詞",
    "meaning": "住家/包吃住。不仅在某个地方工作，还直接住在老板提供的地方。提着简单的行李卷，踏入雇主家的后院或阁楼安顿下来。",
    "example_jp": "彼は親元を離れ、老舗の料亭に住み込みで厳しい板前の修行を始めた。",
    "example_cn": "他背着行囊离开了老家父母，一头扎进一家百年老字号的餐厅里，开始了同吃同住的苦行僧式学徒生活。"
  },
  {
    "id": 800,
    "word": "たちのく",
    ...
    "kana": "たちのく",
    "pos": "自動詞",
    "meaning": "搬出/退租。因为某种要求或危险，被迫从原来居住或停留的地方离开。无奈地打包好最后一个纸箱，锁上那扇不再属于自己的门。",
    "example_jp": "道路拡張工事のため、長年住み慣れたこの古い家を立ち退かなければならない。",
    "example_cn": "因为要拓宽大马路，我迫于无奈，只能咬牙搬离了这栋充满大半辈子回忆的老房子。"
  },
    ];
// 📝 随手记词汇题库 (Notes)
const noteBank = [
