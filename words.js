...
const kundokuBank = [
  ...
  },
  {
    ...
    "kana": "ひっこせる",
    "pos": "動詞",
    "meaning": "能够搬家。动词「引っ越す」的可能形。表示具备搬家的能力或条件（如资金、时间、许可等）。",
    "example_jp": "新しい仕事が決まれば、もっと広い部屋に引っ越せる。",
    "example_cn": "如果定下新工作，就能搬到更宽敞的房间。"
  },
  {
    "id": 152,
    "word": "見据える",
    ...
    "kana": "みすえる",
    "pos": "他動詞",
    "meaning": "定睛注视 / 着眼于。本义是视线固定不动地盯着某物。引申为看清事物本质，或将目光放到未来的目标上，带有坚定和明确目的的动作色彩。",
    "example_jp": "経営陣は常に、十年後の市場の変化を見据える必要がある。",
    "example_cn": "管理层需要始终着眼于十年后的市场变化。"
  },
  {
    "id": 153,
    "word": "繰り返す",
    ...
    "kana": "くりかえす",
    "pos": "他動詞",
    "meaning": "反复 / 重复。多次做同一动作或发生同样的事情。表示动作或事态周而复始的状态。",
    "example_jp": "彼は同じ間違いを何度も繰り返す傾向がある。",
    "example_cn": "他有多次重复同样错误的倾向。"
  },
  {
    "id": 154,
    "word": "振り返る",
    ...
    "kana": "ふりかえる",
    "pos": "自動詞・他動詞",
    "meaning": "回头看 / 回顾。本义是转过头或身体向后看。引申为回想、反省过去发生的事情或经历。",
    "example_jp": "自分の歩んできた人生を振り返る余裕ができた。",
    "example_cn": "产生了回顾自己所走过人生的余暇。"
  },
  {
    "id": 155,
    "word": "沈黙",
    ...
    "kana": "ちんもく",
    "pos": "名詞・自動詞",
    "meaning": "沉默 / 一言不发。指不说话出声的状态，或指原本活跃的事物停止活动。表示现场没有声音或当事人闭口不言的客观状态。",
    "example_jp": "重苦しい沈黙が、会議室を支配していた。",
    "example_cn": "沉重的沉默，支配着会议室。"
  },
  {
    "id": 156,
    "word": "見くびる発言",
    ...
    "kana": "みくびるはつげん",
    "pos": "名詞句",
    "meaning": "贬低人的发言 / 小看人的言论。「見くびる（漢字：見縊る）」意为低估、轻视、看扁。「発言」即言论。组合指故意低估对方能力或价值、带有轻蔑情绪的话语。",
    "example_jp": "相手の努力を見縊る発言は、決して許されるものではない。",
    "example_cn": "小看对方努力的发言，是绝不被允许的。"
  },
  {
    "id": 157,
    "word": "照らし合わせる",
    ...
    "kana": "てらしあわせる",
    "pos": "他動詞",
    "meaning": "核对 / 对照。将两个或多个事物放在一起进行对比，以确认是否一致或寻找差异。通常用于核对数据、事实、账目等具体事物。",
    "example_jp": "提出された領収書を、帳簿の記録と照らし合わせる。",
    "example_cn": "将提交的收据，与账簿的记录进行核对。"
  },
  {
    "id": 158,
    "word": "振る舞う",
    ...
    "kana": "ふるまう",
    "pos": "自動詞・他動詞",
    "meaning": "举止 / 表现 / 款待。作为自动词，指在别人面前展现出的动作或态度；作为他动词，指拿出食物或酒水招待他人。",
    "example_jp": "彼は大勢の前でも、堂々と振る舞うことができる。",
    "example_cn": "他即使在众人面前，也能表现得堂堂正正。"
  },
  {
    "id": 159,
    "word": "研ぎ澄ます",
    ...
    "kana": "とぎすます",
    "pos": "他動詞",
    "meaning": "磨砺 / 使敏锐。本义是将刀剑等刃物磨得极其锋利。引申为将神经、感觉或精神集中到极限，使其变得极为敏锐的状态。",
    "example_jp": "試合の前、選手たちは極限まで感覚を研ぎ澄ましていた。",
    "example_cn": "比赛前，选手们将感觉磨砺到了极限。"
  },
  {
    "id": 160,
    "word": "鼻柱",
    ...
    "kana": "はなばしら",
    "pos": "名詞",
    "meaning": "鼻梁 / 傲气。本义为鼻子的隆起部分。因昂首挺胸时鼻梁显得高，引申为不服输、强势的态度或傲气。常用于表达性格要强。",
    "example_jp": "鼻柱の強い彼女が、珍しく弱音を吐いた。",
    "example_cn": "傲气十足的她，罕见地说了泄气话。"
  },
  {
    "id": 161,
    "word": "虜",
    ...
    "kana": "とりこ",
    "pos": "名詞",
    "meaning": "俘虏 / 被迷住的人。本义是在战争中被活捉的敌人。引申为心被某人或某种魅力深深吸引、无法自拔的心理状态。",
    "example_jp": "私はその美しい旋律の虜になってしまった。",
    "example_cn": "我成为了那美妙旋律的俘虏。"
  },
  {
    "id": 162,
    "word": "生身",
    ...
    "kana": "なまみ",
    "pos": "名詞",
    "meaning": "血肉之躯 / 活生生的肉体。指活着的人的身体。强调肉体具有痛觉、脆弱、会流血的真实存在感，区别于机械或虚拟存在。",
    "example_jp": "生身の体で、あの過酷な環境を生き抜くのは不可能だ。",
    "example_cn": "以血肉之躯，在那个严酷的环境中存活下来是不可能的。"
  },
  {
    "id": 163,
    "word": "戯れる",
    ...
    "kana": "たわむれる",
    "pos": "自動詞",
    "meaning": "嬉戏 / 玩耍 / 调情。怀着轻松的心情玩乐，或指男女间带有调情意味的互动。※与第三列「揶揄う（嘲弄/戏弄）」的区别：「戯れる」侧重双方共同参与的玩乐或亲昵，无恶意；而「揶揄う」侧重单方面用言语逗弄对方看其反应，可能引起不快。",
    "example_jp": "春の野原で、子供たちが犬と楽しそうに戯れている。",
    "example_cn": "在春天的原野上，孩子们正开心地和狗嬉戏着。"
  },
  {
    "id": 164,
    "word": "詰め寄られる",
    ...
    "kana": "つめよられる",
    "pos": "動詞",
    "meaning": "被逼问 / 被步步紧逼。动词「詰め寄る」（逼近、严厉追问）的被动形。表示在物理距离或言语上受到对方强烈的压迫和质问，陷入被动状态。",
    "example_jp": "責任を問う住民たちに詰め寄られ、市長は言葉を失った。",
    "example_cn": "被追究责任的居民们步步紧逼，市长失去了言语。"
  },
  {
    "id": 165,
    "word": "明るい兆し",
    ...
    "kana": "あかるいきざし",
    "pos": "名詞句",
    "meaning": "好兆头 / 光明的迹象。「明るい」指有希望的；「兆し」指事物发生前显露出的预兆。指情况正朝着好的方向发展的征兆。",
    "example_jp": "長い交渉の末に、ようやく解決の明るい兆しが見えた。",
    "example_cn": "经过漫长的谈判，终于看到了解决的光明迹象。"
  },
  {
    "id": 166,
    "word": "裏腹な気持ち",
    ...
    "kana": "うらはらなきもち",
    "pos": "名詞句",
    "meaning": "矛盾的心情 / 言不由衷的情感。「裏腹」指背道而驰、相反。指内心真实想法与表面态度相反，或内心同时存在两种互相冲突的复杂情绪。",
    "example_jp": "彼女を祝いたい反面、嫉妬してしまう裏腹な気持ちがある。",
    "example_cn": "虽然想祝贺她，另一方面却又会嫉妒，有着矛盾的心情。"
  },
  {
    "id": 167,
    "word": "眼差し",
    ...
    "kana": "まなざし",
    "pos": "名詞",
    "meaning": "眼神 / 目光。看向某人或某物时的视线及其中蕴含的感情。比单纯的「視線」更强调目光中带有的情绪色彩和人情味。",
    "example_jp": "彼はまるで宝物を扱うような、優しい眼差しで彼女を見つめた。",
    "example_cn": "他用仿佛对待宝物一般温柔的眼神注视着她。"
  },
  {
    "id": 168,
    "word": "突き止める",
    ...
    "kana": "つきとめる",
    "pos": "他動詞",
    "meaning": "查明 / 追查到底。彻底调查隐藏的事实、原因或某人的下落，直到弄清真相为止。表达强烈的探究动作。",
    "example_jp": "専門家のチームが、ついに未知のウイルスの感染源を突き止めた。",
    "example_cn": "专家团队终于查明了未知病毒的感染源。"
  },
  {
    "id": 169,
    "word": "襲う",
    ...
    "kana": "おそう",
    "pos": "他動詞",
    "meaning": "袭击 / 侵袭。突然进行武力攻击，或指灾难、强烈的负面情绪（如不安、睡意）突然降临并压倒主体。",
    "example_jp": "突然の激しいめまいが彼女を襲い、その場にうずくまった。",
    "example_cn": "突然的剧烈眩晕袭击了她，（使她）蹲在了当场。"
  },
  {
    "id": 170,
    "word": "幸い",
    ...
    "kana": "さいわい",
    "pos": "名詞・な形容詞・副詞",
    "meaning": "幸运 / 幸亏 / 幸好。指遇到了好的情况，或者在糟糕的局面中侥幸避免了更坏的结果。带有庆幸的情绪色彩。",
    "example_jp": "財布を落としたが、幸いにも親切な人が警察に届けてくれた。",
    "example_cn": "虽然丢了钱包，但幸运的是有亲切的人交给了警察。"
  },
  {
    "id": 171,
    "word": "横たわる",
    ...
    "kana": "よこたわる",
    "pos": "自動詞",
    "meaning": "躺卧 / 横亘。人或动物横着身体躺下；也指山脉、河流、问题等庞大的事物横卧在前面或两者之间，阻挡去路的状态。",
    "example_jp": "彼の目の前には、解決困難な問題が大きく横たわっていた。",
    "example_cn": "他的眼前，大大地横亘着难以解决的问题。"
  },
  {
    "id": 172,
    "word": "琴",
    ...
    "kana": "こと",
    "pos": "名詞",
    "meaning": "筝 / 琴。日本的一种传统拨弦乐器。也常用于比喻触动内心的某根弦（心の琴線に触れる）。",
    "example_jp": "障子越しに、微かに琴を弾く音が聞こえてきた。",
    "example_cn": "隔着纸门，听到了微弱的弹琴声。"
  },
  {
    "id": 173,
    "word": "響き",
    ...
    "kana": "ひびき",
    "pos": "名詞",
    "meaning": "声响 / 回音 / 感受。声音的传播和回荡；也指话语或事情传达到人耳中时留下的印象或引起的心理共鸣。",
    "example_jp": "その言葉の冷たい響きに、彼女は思わず肩を震わせた。",
    "example_cn": "因为那句话冰冷的回音，她不由得颤抖了肩膀。"
  },
  {
    "id": 174,
    "word": "心地よい",
    ...
    "kana": "ここちよい",
    "pos": "い形容詞",
    "meaning": "惬意的 / 舒服的。身体或精神上感受到愉悦、舒畅，没有不适感。常用来形容感官刺激（如微风、节奏、疲劳感）带来的良好体验。",
    "example_jp": "適度な運動の後の、心地よい疲労感が好きだ。",
    "example_cn": "我喜欢适度运动之后的，那种惬意的疲劳感。"
  },
  {
    "id": 175,
    "word": "大げさ",
    ...
    "kana": "おおげさ",
    "pos": "な形容詞・名詞",
    "meaning": "夸张的 / 小题大做的。将事物描述或表现得比实际情况更严重、更大或更华丽。表示超出了实情或常理的尺度。",
    "example_jp": "彼はかすり傷を負っただけで、大袈裟に痛がって見せた。",
    "example_cn": "他只是受了擦伤，却表现出极其夸张的疼痛感。"
  },
  {
    "id": 176,
    "word": "取り調べる",
    ...
    "kana": "とりしらべる",
    "pos": "他動詞",
    "meaning": "调查 / 审讯。彻底查明情况，特指警察或检察机关对犯罪嫌疑人或证人进行询问以查明案件真相的官方程序动作。",
    "example_jp": "刑事たちは深夜まで、容疑者を厳しく取り調べた。",
    "example_cn": "刑警们严厉地审讯嫌疑人直到深夜。"
  },
  {
    "id": 177,
    "word": "小柄",
    ...
    "kana": "こがら",
    "pos": "な形容詞・名詞",
    "meaning": "身材娇小 / 矮小。指人的骨架小、体型比普通人要娇小。通常是客观描述体格特征，不带贬义。",
    "example_jp": "小柄な彼女だが、内に秘めたエネルギーは誰よりも大きい。",
    "example_cn": "虽然她是娇小的身材，但内藏的能量比任何人都大。"
  },
  {
    "id": 178,
    "word": "掬う",
    ...
    "kana": "すくう",
    "pos": "他動詞",
    "meaning": "捧起 / 舀起。用手掌并拢成凹状，或用勺子、网等工具从下往上将液体或粉末状的东西捞取上来的动作。",
    "example_jp": "両手で澄んだ湧き水を掬い、ゆっくりと飲み干した。",
    "example_cn": "用双手捧起清澈的泉水，慢慢地喝光了。"
  },
  {
    "id": 179,
    "word": "脅かす",
    ...
    "kana": "おびやかす",
    "pos": "他動詞",
    "meaning": "威胁 / 危及。通过某种力量或事态恶化，使原本安定的状态、地位或安全面临危险，让人生畏。注意与「脅かす（おどろかす，吓唬）」的区别。",
    "example_jp": "長引くインフレが、市民の平穏な生活を脅かしている。",
    "example_cn": "持续的通货膨胀，正威胁着市民的平静生活。"
  },
  {
    "id": 180,
    "word": "面影",
    ...
    "kana": "おもかげ",
    "pos": "名詞",
    "meaning": "容貌的痕迹 / 昔日面貌。浮现在脑海中的人脸或姿态；或指现在的样貌中残留的过去的样子。带有怀旧的情感色彩。",
    "example_jp": "成長した青年の顔に、幼い頃の面影を探した。",
    "example_cn": "在成长后的青年脸上，寻找了小时候的面影。"
  },
  {
    "id": 181,
    "word": "括る",
    ...
    "kana": "くくる",
    "pos": "他動詞",
    "meaning": "捆扎 / 总结 / 统一。本义是用绳子等将散乱的东西绑紧。引申为将多个事物归结到一起，或给事物定性、下定论（如：一括りにする）。",
    "example_jp": "全ての若者を「最近の若者」と一つに括るのは乱暴だ。",
    "example_cn": "将所有的年轻人都用“最近的年轻人”统一概括是粗暴的。"
  },
  {
    "id": 182,
    "word": "待ちかねる",
    ...
    "kana": "まちかねる",
    "pos": "動詞",
    "meaning": "急切盼望 / 等得不耐烦。动词「待つ」加上后缀「かねる」（难以做到），表示期待的心情过于强烈，以至于觉得等待的时间无比漫长，难以忍受。",
    "example_jp": "開演を待ち兼ねた観客から、自然と拍手が湧き起こった。",
    "example_cn": "从急切盼望开演的观众那里，自然地涌起了掌声。"
  },
  {
    "id": 183,
    "word": "引き伸ばす",
    ...
    "kana": "ひきのばす",
    "pos": "他動詞",
    "meaning": "放大 / 拉长 / 拖延。用力将物体拉长；将照片尺寸放大；或指故意拖延时间、推迟决定的期限。",
    "example_jp": "相手の返答を待つ間、意図的に会議の時間を引き伸ばした。",
    "example_cn": "在等待对方答复期间，有意地拖延了会议的时间。"
  },
  {
    "id": 184,
    "word": "度忘れ",
    ...
    "kana": "どわすれ",
    "pos": "名詞・他動詞",
    "meaning": "一时想不起来 / 瞬间遗忘。平时明明很熟悉、知道的事情，在某个瞬间突然从脑海中消失，怎么也想不起来的状态。",
    "example_jp": "彼の名前が喉まで出かかっているのに、完全に度忘れしてしまった。",
    "example_cn": "他的名字明明都到嘴边了，却完全想不起来了。"
  },
  {
    "id": 185,
    "word": "疑い深い",
    ...
    "kana": "うたがいぶかい",
    "pos": "い形容詞",
    "meaning": "多疑的 / 爱起疑心的。性格上不容易相信他人或事物，容易产生怀疑和猜忌。表示怀疑的程度很深。",
    "example_jp": "疑い深い性格の彼は、他人の親切にも裏があると考えた。",
    "example_cn": "性格多疑的他，认为他人的亲切也有内情。"
  },
  {
    "id": 186,
    "word": "婀娜めく",
    ...
    "kana": "あだめく",
    "pos": "動詞",
    "meaning": "显得妖娆 / 娇艳动人。「婀娜」指女性姿态柔美、具有吸引异性的娇媚魅力。「めく」指呈现出某种状态。形容女性举止或打扮显得十分妖艳迷人的视觉状态。",
    "example_jp": "薄紅色の着物をまとった彼女は、普段よりも婀娜めいて見えた。",
    "example_cn": "披着淡红色和服的她，看起来比平时更加娇艳动人。"
  },
  {
    "id": 187,
    "word": "押して",
    ...
    "kana": "おして",
    "pos": "表現",
    "meaning": "强行 / 顶住（困难等）。动词「推す/押す」的て形。常以「無理を押して」「病気を押して」的形式出现，表示不顾外在的阻碍、身体的不适或反对意见，强行去做某事的意志。",
    "example_jp": "周囲の反対を押して、彼は一人で起業する道を選んだ。",
    "example_cn": "顶住周围的反对，他选择了独自创业的道路。"
  },
  {
    "id": 188,
    "word": "縮まる",
    ...
    "kana": "ちぢまる",
    "pos": "自動詞",
    "meaning": "缩短 / 缩小。物理上的长度、大小变短；或指两者之间的距离、差距（如年龄、分数、心理距离）变小。",
    "example_jp": "ゴール手前で、先頭との距離が一気に縮まった。",
    "example_cn": "在终点前，与领先者的距离一下子缩短了。"
  },
  {
    "id": 189,
    "word": "猛〜",
    ...
    "kana": "もう〜",
    "pos": "接頭辞",
    "meaning": "猛烈〜 / 极度〜。作为前缀接在名词或动词性名词前（如猛練習、猛反対），表示程度极其强烈，势头猛烈。",
    "example_jp": "テスト前の猛勉強の甲斐あって、なんとか合格できた。",
    "example_cn": "考前猛烈学习有了价值，总算及格了。"
  },
  {
    "id": 190,
    "word": "禁じる",
    ...
    "kana": "きんじる",
    "pos": "他動詞",
    "meaning": "禁止 / 压抑。通过命令或法规不允许做某事；也指压抑住内心涌现出的某种强烈感情（如：涙を禁じ得ない）。",
    "example_jp": "この美術館では、展示品の写真撮影を固く禁じている。",
    "example_cn": "这家美术馆里，严厉禁止拍摄展品的照片。"
  },
  {
    "id": 191,
    "word": "差し掛かる",
    ...
    "kana": "さしかかる",
    "pos": "自動詞",
    "meaning": "来到 / 临近。移动中正好到达某处地点；或者时间、事态发展到了某个特定的关键阶段或转折点。",
    "example_jp": "物語がいよいよ佳境に差し掛かる頃、夜が明けた。",
    "example_cn": "当故事终于临近高潮时，天亮了。"
  },
  {
    "id": 192,
    "word": "図抜ける",
    ...
    "kana": "ずぬける",
    "pos": "自動詞",
    "meaning": "出类拔萃 / 远超常人。「図」在此指一般的标准或程度。意为体格、能力或某种性质远远超出了普通人的水平，非常突出。",
    "example_jp": "彼はクラスの中でも、図抜けて背が高かった。",
    "example_cn": "即使在班级中，他也是出类拔萃地个子高。"
  },
  {
    "id": 193,
    "word": "後ろ向き",
    ...
    "kana": "うしろむき",
    "pos": "名詞・な形容詞",
    "meaning": "背向 / 消极。物理上背向前方；引申为对事物的态度消极、退缩，不愿面对挑战或缺乏积极解决问题的心理状态。",
    "example_jp": "失敗ばかり気にして、後ろ向きな考え方に陥ってはいけない。",
    "example_cn": "不能只在意失败，陷入消极的思考方式。"
  },
  {
    "id": 194,
    "word": "早める",
    ...
    "kana": "はやめる",
    "pos": "他動詞",
    "meaning": "提前 / 加速。人为地将预定时间往前挪或加快事物进程。※与第三列「予て/予め」的区别：「予め」是副词，意为“事先、早前”，侧重事前做好准备；而「早める」是改变时间进度的动词动作。",
    "example_jp": "天候の悪化が予想されるため、出発を早めることにした。",
    "example_cn": "由于预计天气恶化，决定将出发提前。"
  },
  {
    "id": 195,
    "word": "年の瀬",
    ...
    "kana": "としのせ",
    "pos": "名詞",
    "meaning": "岁末 / 年关。「瀬」本指河流湍急处，引申为难关或繁忙时期。特指年末十二月异常繁忙、时间紧迫、事务繁多的时期。",
    "example_jp": "押し迫った年の瀬に、大きな事件が立て続けに起きた。",
    "example_cn": "在逼近的岁末，接连发生了大事件。"
  },
  {
    "id": 196,
    "word": "仕掛け",
    ...
    "kana": "しかけ",
    "pos": "名詞",
    "meaning": "机关 / 诡计 / 诀窍。为了达到某种目的而预先设置的构造或装置；也指事情内部隐藏的机制或巧妙的设计。",
    "example_jp": "このからくり箱には、複雑な仕掛けが施されている。",
    "example_cn": "这个机关盒里，施加着复杂的机关。"
  },
  {
    "id": 197,
    "word": "錐",
    ...
    "kana": "きり",
    "pos": "名詞",
    "meaning": "锥子。在木头等上钻孔用的尖锐工具。常出现在惯用语中，形容极其集中的事物或疼痛（如：錐で揉まれるような痛み）。",
    "example_jp": "胃の奥が、錐で突かれたように鋭く痛んだ。",
    "example_cn": "胃的深处，如同被锥子刺中般锐利地痛了起来。"
  },
  {
    "id": 198,
    "word": "身の回り",
    ...
    "kana": "みのまわり",
    "pos": "名詞",
    "meaning": "身边事物 / 日常生活。指自己身边携带的物品（衣服、随身物品），或与自己日常生活息息相关的琐事。",
    "example_jp": "祖母は百歳を超えても、身の回りのことは全て自分で行う。",
    "example_cn": "祖母即使超过了一百岁，身边日常的事情也都全部自己做。"
  },
  {
    "id": 199,
    "word": "蔑む",
    ...
    "kana": "さげすむ",
    "pos": "他動詞",
    "meaning": "蔑视 / 鄙视。认为对方比自己低下而投以轻蔑的目光。※与第三列「蔑ろ（ないがしろ）」的区别：「蔑ろ」意为“无视、怠慢”，侧重于不重视；而「蔑む」侧重于主动鄙视、瞧不起的心理和态度。",
    "example_jp": "人の弱点を見つけて蔑むような態度は、誰からも好かれない。",
    "example_cn": "找出他人的弱点并加以蔑视的态度，不被任何人喜欢。"
  },
  {
    "id": 200,
    "word": "澄み渡る",
    ...
    "kana": "すみわたる",
    "pos": "自動詞",
    "meaning": "极其清澈 / 万里无云。「澄む（清澈）」加上「渡る（波及整个范围）」。指天空、空气毫无浑浊；也用于形容声音清脆响亮。",
    "example_jp": "雪山の頂で深呼吸すると、澄み渡った空気が肺を満たした。",
    "example_cn": "在雪山顶深呼吸，极其清澈的空气充满了肺部。"
  },
  {
    "id": 201,
    "word": "ひだりまき",
